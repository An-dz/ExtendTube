...
function fillAbout() {
	...
	if (abtauthor = widget.authorEmail) {
		...
		abtemail.insertAdjacentHTML("afterbegin",
									"<a href=\"mailto:pdarko@myopera.com\">pdarko@myopera.com</a><br/><a href=\"mailto:" + abtauthor + "\">" + abtauthor + "</a>")
	}
	if (abtauthor = widget.authorHref) {
		abtpage.removeChild(abtpage.firstElementChild)
		abtpage.insertAdjacentHTML("afterbegin", "<a href=\"http://my.opera.com/pdarko\">http://my.opera.com/pdarko</a><br/><a href=\"" + abtauthor + "\">" + abtauthor + "</a>")
	}
