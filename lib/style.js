...
.c4-checklist-module .checklist-item .checklist-item-title-text .todo-title-text,\n\
.c4-checklist-module .checklist-item.done .checklist-item-title-text,\n\
...
.secondary-header-contents .nav-text:hover,\n\
...
.site-center-aligned #masthead-positioner:hover #appbar-guide-button:hover,\n\
...
.site-center-aligned #masthead-positioner:hover #appbar-guide-button:active,\n\
...
.site-center-aligned #masthead-positioner:hover #appbar-guide-button:focus,\n\
...
.content-snap-width-2 .flex-width-enabled .welcome-recent-activity .recent-activity-snippet,\n\
.content-snap-width-3 .flex-width-enabled .welcome-recent-activity .recent-activity-snippet,\n\
.content-snap-width-2 .flex-width-enabled .welcome-recent-activity .snippet-hidden-when-compact,\n\
.content-snap-width-3 .flex-width-enabled .welcome-recent-activity .snippet-hidden-when-compact {\n\
	width: 100% !important;\n\
}\n\
img[class^=\"flag_\"] {\n\
