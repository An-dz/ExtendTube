...
var style = {
		...
		cleanwatch: {
			addtobutton: "\
[data-trigger-for=\"action-panel-none\"] {\n\
...
#page.watch #content,\n\
#page.watch,\n\
.exp-new-site-width #page.watch #guide + #content,\n\
.exp-new-site-width #page.watch {\n\
...
body .yt-uix-button-text[disabled] {\n\
	text-shadow: 0 1px 0 @color@ !important;\n\
	color: @color@ !important;\n\
}\n\
...
.channels-browse-filter {\n\
	text-shadow: 0px 1px 0px @color@ !important;\n\
}\n",
			linkHover: "\
...
.yt-uix-button-translation-button.yt-uix-button {\n\
	box-shadow: inset 0px -1px 1px @color@ !important;\n\
}\n",
			buttonBackground: "\
.ext-lyrics:hover .yt-uix-button-text,\n\
.help-Helpwidgets-HelpPanel input.help-Helpwidgets-HelpPanel-Search-Button,\n\
...
body .yt-uix-button-default[disabled] {\n\
	background-color: @color@ !important;\n\
	background-image: -o-linear-gradient(top, hsla(0, 0%, 97%, .1), transparent) !important;\n\
	background-image: linear-gradient(to bottom, hsla(0, 0%, 97%, .1), transparent) !important;\n\
}\n",
			buttonTextHover: "\
...
.yt-uix-form-input-select:hover {\n\
	background-color: @color@ !important;\n\
	background-image: -o-linear-gradient(top, hsla(0, 0%, 0%, .05), transparent) !important;\n\
	background-image: linear-gradient(to bottom, hsla(0, 0%, 0%, .05), transparent) !important;\n\
}\n",
			buttonTextActive: "\
...
.yt-uix-form-input-select:active {\n\
	border-color: @color@ !important;\n\
	box-shadow: 0px 0px 5px @color@, inset 0px 0px 8px hsla(0, 0%, 0%, .2) !important;\n\
}\n\
.epic-nav-item-heading,\n\
.epic-nav-item.selected,\n\
body a.yt-uix-button-epic-nav-item.selected,\n\
...
.yt-uix-form-input-select:active {\n\
	background-color: @color@ !important;\n\
	background-image: -o-linear-gradient(top, hsla(0, 0%, 0%, .1), transparent, hsla(0, 0%, 0%, .1)) !important;\n\
	background-image: linear-gradient(to bottom, hsla(0, 0%, 0%, .1), transparent, hsla(0, 0%, 0%, .1)) !important;\n\
}\n",
			buttonTextFocused: "\
...
.yt-uix-form-input-textarea:focus {\n\
	border-color: @color@ !important;\n\
	box-shadow: 0px 0px 5px @color@, inset 0px 0px 5px hsla(0, 0%, 0%, .3) !important;\n\
}\n",
...
.help-Helpwidgets-HelpPanel-Help-Center-Anchor,\n\
.yt-uix-button-primary,\n\
body .yt-uix-button-primary[disabled] {\n\
	background-color: @color@ !important;\n\
	background-image: -o-linear-gradient(top, hsla(0, 0%, 97%, .1), transparent) !important;\n\
	background-image: linear-gradient(to bottom, hsla(0, 0%, 97%, .1), transparent) !important;\n\
}\n",
...
.help-Helpwidgets-HelpPanel-Help-Center-Anchor,\n\
.yt-uix-button-primary,\n\
a.yt-uix-button-primary .yt-uix-button-content {\n\
	color: @color@ !important;\n\
}\n",
			primaryButtonBackgroundHover: "\
.help-Helpwidgets-HelpPanel-Help-Center-Anchor:hover,\n\
...
.help-Helpwidgets-HelpPanel-Help-Center-Anchor:hover,\n\
.yt-uix-button-primary:hover,\n\
a.yt-uix-button-primary:hover .yt-uix-button-content {\n\
	color: @color@ !important;\n\
}\n",
			videoThumbnail: "\
.feed-item-container,\n\
...
a.yt-badge-std {\n\
	color: @color@ !important;\n\
	box-shadow: inset 0 -1px 1px @color@ !important;\n\
}\n",
			badgeBackground: "\
.item-badge-label,\n\
.yt-badge-live,\n\
...
.masthead-search-terms-border {\n\
	box-shadow: inset 0px 0px 8px hsla(0, 0%, 0%, .5) !important;\n\
}\n\
...
form#masthead-search.consolidated-form input:focus {\n\
	box-shadow: 0px 0px 5px hsl(0, 0%, 10%), inset 0px 0px 6px hsl(0, 0%, 50%) !important;\n\
}\n",
		/**
		 * Logo replacement.
		 */
...
.ext-popout-player .channels-video-player,\n\
.ext-popout-player #player,\n\
.ext-popout-player #watch7-video,\n\
.ext-popout-player #watch-video {\n\
	position: fixed !important;\n\
	padding: 0 !important;\n\
	margin: 0 !important;\n\
	top: 0 !important;\n\
...
.channels-video-player .player-container,\n\
#player-api,\n\
#watch7-player,\n\
#watch-player {\n\
...
.ext-popout-player .channels-video-player .player-container,\n\
.ext-popout-player #player-api,\n\
.ext-popout-player #watch7-player,\n\
.ext-popout-player #watch-player {\n\
	width: @width px !important;\n\
	height: @height px !important;\n\
	margin: auto;\n\
