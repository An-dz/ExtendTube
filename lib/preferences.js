...
var defaultPreferences = {
		...
		// Overwrite disableautoplay preference on playlists, making videos on playlists autoplay.
		...
		cleanwatch: {
			...
			guide: false,
			// Hide left guide only in video pages
			guidevid: false,
		...
		customcolor: {
			badgeBackground: "hsl(0, 0%, 95%)",
			badgeText: "hsl(0, 0%, 33%)",
			buttonBackground: "hsl(0, 0%, 97%)",
			buttonBackgroundActive: "hsl(0, 0%, 91%)",
			buttonBackgroundFocused: "hsl(0, 0%, 97%)",
			buttonBackgroundHover: "hsl(0, 0%, 97%)",
			buttonBorder: "hsl(0, 0%, 83%)",
			buttonBorderActive: "hsl(0, 0%, 78%)",
			buttonBorderFocused: "hsl(213, 49%, 48%)",
			...
			clickCardBackground: "hsl(0, 0%, 100%)",
			clickCardBorder: "hsl(0, 0%, 77%)",
			headerFooterBackground: "hsl(0, 0%, 95%)",
			link: "hsl(207, 53%, 52%)",
			linkHover: "hsl(218, 85%, 43%)",
			menuBackground: "hsl(0, 0%, 100%)",
			menuBorder: "hsl(0, 0%, 80%)",
			menuItemBackground: "hsla(0, 0%, 0%, 0)",
			menuItemBackgroundHover: "hsl(0, 0%, 33%)",
			menuItemText: "hsl(0, 0%, 33%)",
			menuItemTextHover: "hsl(0, 0%, 100%)",
			pageBackgroundPrimary: "hsl(0, 0%, 98%)",
			pageBackgroundSecondary: "hsl(0, 0%, 100%)",
			pagePrimary: "hsl(0, 0%, 33%)",
			pageSecondary: "hsl(0, 0%, 60%)",
			primaryButtonBackground: "hsl(213, 45%, 54%)",
			primaryButtonBackgroundHover: "hsl(213, 49%, 46%)",
			primaryButtonBorder: "hsl(213, 49%, 48%)",
			primaryButtonBorderHover: "hsl(213, 49%, 38%)",
			primaryButtonText: "hsl(0, 0%, 100%)",
			primaryButtonTextHover: "hsl(0, 0%, 100%)",
			separatorsAndBorders: "hsl(0, 0%, 89%)",
			toolTipBackground: "hsl(0, 0%, 20%)",
			toolTipText: "hsl(0, 0%, 100%)",
			videoThumbnail: "hsla(0, 0%, 0%, 0)",
			videoThumbnailHover: "hsl(0, 0%, 98%)",
		...
		hideplayerads: true,
		// How wide player whould be. Can be "auto", "medium" or "large".
		howwide: "auto",
		// Use this language.
		locale: "en",
...
Array.prototype.forEach.call(document.querySelectorAll(\"a[href*=\\\"/watch\\\"]\"), function (link) {\n\
	if (link.search)\n\
		...
		bufferall: true,
		customcolor: {
			badgeBackground: "hsl(200, 5.59%, 68.431%)",
			badgeText: "hsl(194, 61.702%, 18.431%)",
			buttonBackground: "hsl(195, 8.511%, 18.431%)",
			buttonBackgroundActive: "hsl(216, 61.677%, 32.745%)",
			buttonBackgroundFocused: "hsla(216, 61.677%, 32.745%, 0.8)",
			buttonBackgroundHover: "hsl(210, 74.713%, 17.059%)",
			buttonBorder: "hsl(210, 60.209%, 37.451%)",
			buttonBorderActive: "hsl(90, 91.304%, 31.569%)",
			buttonBorderFocused: "hsl(0, 100%, 32.549%)",
			buttonBorderHover: "hsl(210, 45.064%, 54.314%)",
			buttonText: "hsl(60, 7.692%, 94.902%)",
			buttonTextActive: "hsl(60, 7.692%, 94.902%)",
			buttonTextFocused: "hsl(150, 25%, 93.725%)",
			buttonTextHover: "hsl(60, 100%, 99.608%)",
			clickCardBackground: "hsl(80, 2.013%, 29.216%)",
			clickCardBorder: "hsl(86, 2.811%, 48.824%)",
			headerFooterBackground: "hsl(195, 2.703%, 29.02%)",
			link: "hsl(210, 47.423%, 61.961%)",
			linkHover: "hsl(90, 81.333%, 44.118%)",
			menuBackground: "hsl(105, 3.226%, 24.314%)",
			menuBorder: "hsl(173, 3.774%, 58.431%)",
			menuItemBackground: "hsla(90, 2.299%, 34.118%, 0)",
			menuItemBackgroundHover: "hsla(0, 0%, 100%, 0.2)",
			menuItemText: "hsl(60, 7.692%, 94.902%)",
			menuItemTextHover: "hsl(60, 3.846%, 89.804%)",
			pageBackgroundPrimary: "hsl(120, 2.041%, 9.608%)",
			pageBackgroundSecondary: "hsl(198, 8.475%, 23.137%)",
			pagePrimary: "hsl(60, 11.111%, 94.706%)",
			pageSecondary: "hsl(195, 4.301%, 63.529%)",
			primaryButtonBackground: "hsl(90, 82.143%, 21.961%)",
			primaryButtonBackgroundHover: "hsl(90, 81.421%, 35.882%)",
			primaryButtonBorder: "hsl(90, 82.418%, 35.686%)",
			primaryButtonBorderHover: "hsl(60, 91.444%, 36.667%)",
			primaryButtonText: "hsl(60, 7.692%, 94.902%)",
			primaryButtonTextHover: "hsl(60, 3.846%, 89.804%)",
			separatorsAndBorders: "hsl(84, 2.513%, 39.02%)",
			toolTipBackground: "hsl(0, 0%, 100%)",
			toolTipText: "hsl(200, 8.571%, 13.725%)",
			videoThumbnail: "hsla(195, 60.36%, 21.765%, 0)",
			videoThumbnailHover: "hsla(90, 8.929%, 78.039%, 0.15)",
			videoTitle: "hsla(30, 100%, 47.647%, 0.8)"
		},
		customstyle: "\
