...
var defaultPreferences = {
		...
		cleanwatch: {
			...
			guide: false,
				// Hide left guide list only on video pages.
				guidevid: false,
		...
		customcolor: {
			badgeBackground: "hsl(24, 100%, 57.647%)",
			badgeText: "hsl(24, 100%, 57.647%)",
			...
			menuItemBackgroundHover: "hsl(0, 0%, 20%)",
			menuItemText: "hsl(0, 0%, 20%)",
			menuItemTextHover: "hsl(0, 0%, 100%)",
			pageBackgroundPrimary: "hsl(0, 0%, 100%)",
			pageBackgroundSecondary: "hsl(0, 0%, 100%)",
			pagePrimary: "hsl(0, 0%, 33%)",
			pageSecondary: "hsl(0, 0%, 33%)",
			...
			separatorsAndBorders: "hsl(0, 0%, 91%)",
