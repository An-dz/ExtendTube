...
STOP_PLAYER:				"وقف التخزين المؤقت الفيديو",
...
STOP_PLAYER:				"Спрете буфериране видео",
POPOUT_PLAYER:				"Покажи само видео",
...
PREVIEW_START:				"Кликнете да започне предварителен преглед на видео.",
PREVIEW_END:				"Натиснете до края на предварителен преглед на видео.",
...
RATING_LIKE:				"%pcent% харесвания",
RATING_NO_DATA:				"Рейтинг не е налична."
},
...
DOWNLOAD_UNKNOWN_TIP:		"невядомы фармат відэа",
STEP_FRAME_FORWARD:			"Перасунуцца на кадр наперад",
SEEK_FORWARD:				"Шукаць наперад",
SEEK_BACK:					"Шукаць назад",
STOP_PLAYER:				"Спыніць буферызацыі відэа",
POPOUT_PLAYER:				"Паказаць толькі відэа",
...
PREVIEW_START:				"Націсніце, каб пачаць прагляд відэа.",
PREVIEW_END:				"Націсніце да канца папярэдняга прагляду відэа.",
...
RATING_LIKE:				"%pcent% як",
RATING_NO_DATA:				"Рэйтынг не даступныя."
},
// বাংলা (Bengali)
"bn": {
PREFERENCES:				"পছন্দ...",
...
SEEK_BACK:					"ফিরে খোঁজ",
STOP_PLAYER:				"ভিডিও বাফার উপলব্ধ করা বন্ধ করুন",
...
STOP_PLAYER:				"Aturar buffering de vídeo",
...
DOWNLOAD_UNKNOWN_TIP:		"neznámý formát videa",
STEP_FRAME_FORWARD:			"Krok o jeden snímek vpřed",
SEEK_FORWARD:				"Skok vpřed",
SEEK_BACK:					"Skok zpět",
STOP_PLAYER:				"Zastavení videa do vyrovnávací paměti",
POPOUT_PLAYER:				"Zobrazit pouze video",
...
PREVIEW_START:				"Klepněte na tlačítko pro spuštění videa náhledu.",
PREVIEW_END:				"Klikněte do konce náhled videa.",
...
RATING_LIKE:				"Líbí se: %pcent%",
RATING_NO_DATA:				"Hodnocení není k dispozici."
},
// Dansk (Danish)
//	Thanks to:
...
DOWNLOAD_UNKNOWN_TIP:		"ukendt videoformat",
STEP_FRAME_FORWARD:			"Gå et billede frem",
SEEK_FORWARD:				"Spol frem",
SEEK_BACK:					"Spol tilbage",
STOP_PLAYER:				"Stop video buffering",
POPOUT_PLAYER:				"Pop ud videoafspiller",
...
PREVIEW_START:				"Klik for at starte video preview.",
PREVIEW_END:				"Klik for at afslutte video preview.",
...
RATING_LIKE:				"%pcent% synes godt om",
RATING_NO_DATA:				"Video bedømmelse ikke tilgængelig."
},
// Deutsch (German)
//	Thanks to:
//		Ralf Beckebans
...
DOWNLOAD_UNKNOWN_TIP:		"unbekannten Video-Format",
STEP_FRAME_FORWARD:			"Einen Frame vorwärts",
SEEK_FORWARD:				"Vorspulen",
SEEK_BACK:					"Zurückspulen",
STOP_PLAYER:				"Stopp des Videos Pufferung",
POPOUT_PLAYER:				"Video zeigen nur",
...
PREVIEW_START:				"Hier klicken, um Video-Vorschau zu starten.",
PREVIEW_END:				"Hier klicken, um Video-Vorschau zu beenden.",
...
RATING_LIKE:				"Gefällt %pcent%",
RATING_NO_DATA:				"Bewertung nicht verfügbar."
},
// Ελληνικά (Greek)
//	Thanks to:
...
DOWNLOAD_UNKNOWN_TIP:		"άγνωστη μορφή βίντεο",
STEP_FRAME_FORWARD:			"Ένα πλαίσιο μπροστά",
SEEK_FORWARD:				"Μπροστά",
SEEK_BACK:					"Πίσω",
STOP_PLAYER:				"Σταματήστε buffering βίντεο",
POPOUT_PLAYER:				"Προβολή βίντεο μόνο",
...
PREVIEW_START:				"Κάντε κλικ στο κουμπί για να ξεκινήσει προεπισκόπηση βίντεο.",
PREVIEW_END:				"Κάντε κλικ στο τέλος προεπισκόπηση βίντεο.",
...
RATING_LIKE:				"%pcent% θετικές",
RATING_NO_DATA:				"Αξιολόγηση δεν είναι διαθέσιμη."
},
// English (English)
...
DOWNLOAD_UNKNOWN_TIP:		"formato de vídeo desconocido",
STEP_FRAME_FORWARD:			"Saltar un frame adelante",
SEEK_FORWARD:				"Buscar adelante",
SEEK_BACK:					"Buscar atras",
STOP_PLAYER:				"Detener buffering de vídeo",
POPOUT_PLAYER:				"Videos mostrando sólo",
...
PREVIEW_START:				"Haga clic para empezar a vista previa de vídeo.",
PREVIEW_END:				"Haga clic para finalizar vista previa de vídeo.",
...
RATING_LIKE:				"Me gusta: %pcent%",
RATING_NO_DATA:				"Categoría no disponible."
},
// Eesti keel (Estonian)
//	Thanks to:
//		Alexander Assmann
...
DOWNLOAD_UNKNOWN_TIP:		"tundmatu videoformaadis",
STEP_FRAME_FORWARD:			"Üks kaader edasi",
SEEK_FORWARD:				"Keri edasi",
SEEK_BACK:					"Keri tagasi",
STOP_PLAYER:				"Peata video puhverdusvõime",
POPOUT_PLAYER:				"Tupsahtaa videopleier",
...
PREVIEW_START:				"Klõpsake alustamiseks video eelvaade.",
PREVIEW_END:				"Klikka end video eelvaade.",
...
RATING_LIKE:				"%pcent% kasutajale meeldis",
RATING_NO_DATA:				"Hinnang ei ole saadaval."
},
// Euskara (Basque)
"eu": {
PREFERENCES:				"Aukerak...",
...
SEEK_BACK:					"Jo atzera",
STOP_PLAYER:				"Gelditu bideo buferra",
...
DOWNLOAD_UNKNOWN_TIP:		"فرمت های تصویری ناشناخته",
STEP_FRAME_FORWARD:			"يک فريم به جلو",
SEEK_FORWARD:				"جلو بردن",
SEEK_BACK:					"عقب بردن",
STOP_PLAYER:				"توقف بافر ویدیو",
POPOUT_PLAYER:				"پاپ از پخش ویدئو",
...
PREVIEW_START:				"بر روی پیش نمایش فیلم برای شروع کلیک کنید.",
PREVIEW_END:				"بر روی پیش نمایش فیلم برای پایان دادن به کلیک کنید.",
...
RATING_LIKE:				"%pcent% دوست داشتن",
RATING_NO_DATA:				"رتبه بندی در دسترس نیست."
},
// Suomi (Finnish)
"fi": {
...
STOP_PLAYER:				"Pysäytä video puskurointi",
...
DOWNLOAD_UNKNOWN_TIP:		"format vidéo inconnue",
STEP_FRAME_FORWARD:			"Etape suivante",
SEEK_FORWARD:				"Suivant",
SEEK_BACK:					"Retour",
STOP_PLAYER:				"Arrêtez tampon vidéo",
POPOUT_PLAYER:				"Accent vidéo",
...
PREVIEW_START:				"Cliquez ici pour démarrer prévisualisation vidéo.",
PREVIEW_END:				"Cliquez pour mettre fin à de prévisualisation vidéo.",
...
RATING_LIKE:				"%pcent% aiment",
RATING_NO_DATA:				"Note pas disponibles."
},
// Galego (Galician)
"gl": {
...
STOP_PLAYER:				"Deixe de buffer de vídeo",
...
SEEK_BACK:					"પાછા શોધો",
STOP_PLAYER:				"વિડિઓ બફરીંગને રોકો",
...
STOP_PLAYER:				"वीडियो बफरिंग बंद करो",
...
STOP_PLAYER:				"Zaustavite videa kašnjenje",
...
DOWNLOAD_UNKNOWN_TIP:		"ismeretlen videó formátum",
STEP_FRAME_FORWARD:			"Léptetés egy képkockával elõre",
SEEK_FORWARD:				"Elõre tekerés",
SEEK_BACK:					"Hátra tekerés",
STOP_PLAYER:				"Állítsa le a videó pufferelés",
POPOUT_PLAYER:				"Mutasd csak videó",
...
PREVIEW_START:				"Klikkelj hogy video preview.",
PREVIEW_END:				"Kattints ide a végére video preview.",
...
RATING_LIKE:				"%pcent% embernek tetszik",
RATING_NO_DATA:				"Értékelés nem elérhető."
},
...
STOP_PLAYER:				"Hentikan buffer video yang",
...
STOP_PLAYER:				"Stöðva vídeó höggdeyfir",
...
DOWNLOAD_UNKNOWN_TIP:		"video formato sconosciuto",
STEP_FRAME_FORWARD:			"Avanti di un frame",
SEEK_FORWARD:				"Avanti veloce",
SEEK_BACK:					"Indietro veloce",
STOP_PLAYER:				"Fermare il video di buffering",
POPOUT_PLAYER:				"Mostra solo video",
...
PREVIEW_START:				"Fare clic per avviare anteprima video.",
PREVIEW_END:				"Clicca per fine di anteprima video.",
...
RATING_LIKE:				"%pcent% Mi piace",
RATING_NO_DATA:				"Categoria non disponibile."
},
// 日本語 (Japanese)
//	Thanks to:
...
SEEK_FORWARD:				"前方にシーク",
SEEK_BACK:					"後方にシーク",
STOP_PLAYER:				"ビデオバッファリングを停止する",
POPOUT_PLAYER:				"ビデオのみを表示する",
...
PREVIEW_START:				"ビデオのプレビューを開始するときにクリックします。",
PREVIEW_END:				"ビデオのプレビューを終了する]をクリックします。",
...
RATING_LIKE:				"高評価 %pcent%",
RATING_NO_DATA:				"利用できない評価。"
},
// ಕನ್ನಡ (Kannada)
"kn": {
...
STOP_PLAYER:				"ವೀಡಿಯೊ ಬಫರಿಂಗಿಗೆ ನಿಲ್ಲಿಸಿ",
...
DOWNLOAD_UNKNOWN_TIP:		"nežinomas vaizdo formatas",
STEP_FRAME_FORWARD:			"Vienas kadras į priekį",
SEEK_FORWARD:				"Prasukti į priekį",
SEEK_BACK:					"Atsukti atgal",
STOP_PLAYER:				"Stop vaizdo buferinė",
POPOUT_PLAYER:				"Iššokti vaizdo grotuvas",
...
PREVIEW_START:				"Spustelėkite, jei norite paleisti vaizdo peržiūros.",
PREVIEW_END:				"Spustelėkite, jei norite baigti vaizdo peržiūros.",
...
RATING_LIKE:				"%pcent% teig. įvertinim.",
RATING_NO_DATA:				"Vaizdo įvertinimas nėra."
},
...
STOP_PLAYER:				"Apturēt video buffering",
...
DOWNLOAD_EMPTY:				"(रिकामा)",
DOWNLOAD_EMPTY_TIP:			"डाउनलोड डेटा सापडला नाही",
DOWNLOAD_UNKNOWN_TIP:		"अज्ञात व्हिडिओ स्वरूप",
STEP_FRAME_FORWARD:			"फॉरवर्ड एक फ्रेम चरण",
SEEK_FORWARD:				"अग्रेषित घ्यावी",
SEEK_BACK:					"परत घ्या",
STOP_PLAYER:				"व्हिडिओ बफर थांबवा",
POPOUT_PLAYER:				"व्हिडिओ प्लेअर पॉप आउट",
LOOP_DISABLE:				"पळवाट अक्षम करा",
LOOP_ENABLE:				"पळवाट सक्षम करा",
LOOP_SECTION_DISABLE:		"विभाग पळवाट अक्षम करा",
LOOP_SECTION_ENABLE:		"विभाग पळवाट सक्षम करा",
LOOP_MARK_START:			"मार्क विभाग प्रारंभ",
LOOP_MARK_END:				"मार्क विभाग ओवरनंतर",
PREVIEW_START:				"व्हिडिओ पूर्वावलोकन सुरू करण्यासाठी क्लिक करा.",
PREVIEW_END:				"व्हिडिओ पूर्वावलोकन समाप्त क्लिक करा.",
LYRICS_BUTTON_HIDE:			"गीत लपवा",
LYRICS_BUTTON_SHOW:			"गीत दर्शवा",
LYRICS_BUTTON_LOAD:			"भार",
LYRICS_BUTTON_TRY:			"स्वतः करून पहा...",
LYRICS_LYRICS:				"गीताचे बोल",
LYRICS_LYRICS_FOR:			"साठी गीत: %song",
LYRICS_TITLE_INFO:			"कलाकार आणि शोधण्यासाठी गाण्याचे शीर्षक घाला.",
LYRICS_TITLE_INFO_EX:		"संयोगचिन्ह वेगवेगळ्या करा (त्यामुळे आवडेल: कलावंत - शीर्षक).",
LYRICS_SEARCH_START:		"शोधत आहे “%song”...",
LYRICS_SEARCH_NO_RESULT:	"साठी परिणाम नाही “%song”.",
LYRICS_SEARCH_FOUND:		"गीताचे बोल आढळले. लोड करीत आहे...",
LYRICS_SEARCH_NOT_FOUND:	"गीताचे बोल आढळले नाहीत आणि अधिक जोड्या प्रयत्न करणे.",
LYRICS_PARSE_SEARCH:		"पार्सिंग शोध निकाल...",
LYRICS_PARSE_LYRICS:		"गीत डेटा विश्लेषित...",
LYRICS_PARSE_SUCCESS:		"गीताचे बोल यशस्वीरित्या पार्स.",
LYRICS_PARSE_ERROR:			"गीताचे बोल आहेत परंतु विश्लेषण केले जाऊ शकत नाही. क्षमस्व.",
LYRICS_TITLE_INVALID:		"व्हिडिओ शीर्षक नमुना “कलावंत - शीर्षक” जुळत नाही!",
RATING_LIKE:				"%pcent% आवडले",
RATING_NO_DATA:				"रेटिंग उपलब्ध नाही."
},
// Bahasa Melayu (Malay)
"ms": {
PREFERENCES:				"Pilihan...",
...
STOP_PLAYER:				"Hentikan buffering video",
...
PREVIEW_START:				"Klik om video preview te starten.",
PREVIEW_END:				"Klik om video preview te beëindigen.",
...
RATING_LIKE:				"%pcent% stemmen voor leuk",
RATING_NO_DATA:				"Cijfer niet beschikbaar."
},
// Norsk (Norwegian)
//	Thanks to:
//		Dennis Moe
...
STOP_PLAYER:				"Stopp video buffering",
POPOUT_PLAYER:				"Vis bare video",
...
PREVIEW_START:				"Klikk for å starte video forhåndsvisning.",
PREVIEW_END:				"Klikk for å avslutte forhåndsvisning av video.",
...
RATING_LIKE:				"%pcent% liker",
RATING_NO_DATA:				"Video karakter ikke tilgjengelig."
},
// Polski (Polish)
//	Thanks to:
...
DOWNLOAD_UNKNOWN_TIP:		"nieznany format wideo",
STEP_FRAME_FORWARD:			"Przejdź o jedną klatkę do przodu",
SEEK_FORWARD:				"Przewiń do przodu",
SEEK_BACK:					"Przewiń do tyłu",
STOP_PLAYER:				"Zatrzymaj buforowania wideo",
POPOUT_PLAYER:				"Pokaż tylko wideo",
...
PREVIEW_START:				"Kliknij, aby uruchomić podgląd wideo.",
PREVIEW_END:				"Kliknij, aby zakończyć podgląd wideo.",
...
RATING_LIKE:				"Głosy na tak: %pcent%",
RATING_NO_DATA:				"Ocena nie jest dostępny."
},
...
SEEK_BACK:					"Voltar",
STOP_PLAYER:				"Parar carregamento do vídeo",
POPOUT_PLAYER:				"Desencaixar vídeo",
...
LOOP_MARK_START:			"Marcar início da seção",
LOOP_MARK_END:				"Marcar final da sação",
...
LYRICS_LYRICS_FOR:			"Letras da música: %song",
...
LYRICS_PARSE_SUCCESS:		"Letra da música carregada com sucesso.",
LYRICS_PARSE_ERROR:			"Letra encontrada, porém não pôde ser analizada. Desculpe.",
LYRICS_TITLE_INVALID:		"Título do vídeo não corresponde o padrão “Artista - Título”!",
RATING_LIKE:				"%pcent% gostaram",
...
PREVIEW_START:				"Clique para começar a visualização de vídeo.",
PREVIEW_END:				"Clique para final de visualização de vídeo.",
...
RATING_LIKE:				"%pcent% utilizadores que gostaram deste vídeo",
RATING_NO_DATA:				"Avaliação não disponível."
},
// Română (Romanian)
"ro": {
...
STOP_PLAYER:				"Nu mai tamponare videoclip",
...
DOWNLOAD_UNKNOWN_TIP:		"неизвестный формат видео",
STEP_FRAME_FORWARD:			"Вперед на один кадр",
SEEK_FORWARD:				"Искать вперед",
SEEK_BACK:					"Искать назад",
STOP_PLAYER:				"Остановить буферизации видео",
POPOUT_PLAYER:				"Показать только видео",
...
PREVIEW_START:				"Нажмите, чтобы начать просмотр видео.",
PREVIEW_END:				"Нажмите до конца предварительного просмотра видео.",
...
RATING_LIKE:				"%pcent% понравилось",
RATING_NO_DATA:				"Рейтинг не доступны."
},
// Slovenský (Slovak)
//	Thanks to:
...
DOWNLOAD_UNKNOWN_TIP:		"neznámy formát videa",
STEP_FRAME_FORWARD:			"Krok o jeden snímok vpred",
SEEK_FORWARD:				"Skok vpred",
SEEK_BACK:					"Skok späť",
STOP_PLAYER:				"Zastavenie videa do vyrovnávacej pamäte",
POPOUT_PLAYER:				"Zobraziť iba video",
...
PREVIEW_START:				"Kliknite na tlačidlo pre spustenie videa náhľadu.",
PREVIEW_END:				"Kliknite do konca náhľad videa.",
...
RATING_LIKE:				"%pcent%-krát „Páči sa mi to“",
RATING_NO_DATA:				"Hodnotenie nie je k dispozícii."
},
// Slovenščina (Slovene)
//	Thanks to:
//		Vito Meznaric
...
PREVIEW_START:				"Kliknite za začetek predogled video.",
PREVIEW_END:				"Kliknite za konec predogled video.",
...
RATING_LIKE:				"%pcent% glasov „Všeč mi je“",
RATING_NO_DATA:				"Ocena ni na voljo."
},
// Српски (Serbian)
...
STOP_PLAYER:				"Stoppa video buffring",
...
STOP_PLAYER:				"Kuacha video buffering",
...
STOP_PLAYER:				"வீடியோ அமிலச்செறிவுமாறா நிறுத்த",
...
DOWNLOAD_VIDEO:				"వీడియో డౌన్లోడ్",
DOWNLOAD_EMPTY:				"(ఖాళీ)",
DOWNLOAD_EMPTY_TIP:			"డౌన్లోడ్ కోసం డేటా కనుగొనబడలేదు",
DOWNLOAD_UNKNOWN_TIP:		"తెలియని వీడియో ఫార్మాట్",
STEP_FRAME_FORWARD:			"ముందుకు ఒక ఫ్రేమ్ దశ",
SEEK_FORWARD:				"ముందుకు కోరుకుంటారు",
SEEK_BACK:					"తిరిగి చూసుకోండి",
STOP_PLAYER:				"వీడియో బఫరింగ్ ఆపు",
POPOUT_PLAYER:				"వీడియో ప్లేయర్ పాప్ అవుట్",
LOOP_DISABLE:				"లూప్ ఆపివేయి",
LOOP_ENABLE:				"లూప్ ప్రారంభించు",
LOOP_SECTION_DISABLE:		"విభాగంలో లూప్ నిలిపివేయి",
LOOP_SECTION_ENABLE:		"విభాగంలో లూప్ ప్రారంభించు",
LOOP_MARK_START:			"మార్క్ విభాగం ప్రారంభం",
LOOP_MARK_END:				"మార్క్ విభాగం ముగింపు",
PREVIEW_START:				"వీడియో ప్రివ్యూ ప్రారంభించడానికి క్లిక్ చెయ్యండి.",
PREVIEW_END:				"వీడియో ప్రివ్యూ అంతం క్లిక్ చేయండి.",
LYRICS_BUTTON_HIDE:			"దాచు సాహిత్యం",
LYRICS_BUTTON_SHOW:			"షో సాహిత్యం",
LYRICS_BUTTON_LOAD:			"లోడ్",
LYRICS_BUTTON_TRY:			"మానవీయంగా ప్రయత్నించండి...",
LYRICS_LYRICS:				"పాటలు",
LYRICS_LYRICS_FOR:			"కోసం పాటలు:",
LYRICS_TITLE_INFO:			"కళాకారుడు మరియు శోధించడానికి పాట శీర్షిక ఇన్సర్ట్",
LYRICS_TITLE_INFO_EX:		"అడ్డగీత వేరు (కాబట్టి ఇష్టం: కళాకారుడు - పేరు)",
LYRICS_SEARCH_START:		"కోసం శోధించండి “%song”...",
LYRICS_SEARCH_NO_RESULT:	"కోసం ఫలితాలు లేవు “%song”.",
LYRICS_SEARCH_FOUND:		"సాహిత్యం దొరకలేదు. లోడ్...",
LYRICS_SEARCH_NOT_FOUND:	"సాహిత్యం దొరకలేదు మరియు నో మోర్ కలయికలు ప్రయత్నించండి.",
LYRICS_PARSE_SEARCH:		"పార్సింగ్ శోధన ఫలితాలు...",
LYRICS_PARSE_LYRICS:		"సాహిత్యం డేటా పార్సింగ్...",
LYRICS_PARSE_SUCCESS:		"సాహిత్యం విజయవంతంగా వివరించారు.",
LYRICS_PARSE_ERROR:			"సాహిత్యం చూడవచ్చు కాని అన్వయించడం సాధ్యం కాదు. క్షమించాలి.",
LYRICS_TITLE_INVALID:		"వీడియో శీర్షిక నమూనా “కళాకారుడు - పేరు” సరిపోలడం లేదు!",
RATING_LIKE:				"%pcent% ఇష్టం",
RATING_NO_DATA:				"రేటింగ్ అందుబాటులో లేదు."
},
// ภาษาไทย (Thai)
"th": {
...
SEEK_BACK:					"ขอกลับ",
STOP_PLAYER:				"หยุดบัฟเฟอร์วิดีโอ",
...
STOP_PLAYER:				"Itigil video buffering",
...
DOWNLOAD_UNKNOWN_TIP:		"bilinmeyen video formatı",
STEP_FRAME_FORWARD:			"Bir kare ileri git",
SEEK_FORWARD:				"Geriye git",
SEEK_BACK:					"İleri git",
STOP_PLAYER:				"Video tamponlama durdurmak",
POPOUT_PLAYER:				"Video yalnızca göster",
...
PREVIEW_START:				"Video önizleme başlatmak için tıklayın.",
PREVIEW_END:				"Video önizleme bitirmek için tıklayın.",
...
RATING_LIKE:				"%pcent% gibi",
RATING_NO_DATA:				"Değerlendirme kullanılabilir değil."
},
...
DOWNLOAD_UNKNOWN_TIP:		"невідомий формат відео",
STEP_FRAME_FORWARD:			"Один кадр вперед",
SEEK_FORWARD:				"Переміститися вперед",
SEEK_BACK:					"Переміститися назад",
STOP_PLAYER:				"Зупинити буферизації відео",
POPOUT_PLAYER:				"Показати тільки відео",
...
PREVIEW_START:				"Натисніть, щоб почати перегляд відео.",
PREVIEW_END:				"Натисніть до кінця попереднього перегляду відео.",
...
RATING_LIKE:				"Сподобалося: %pcent%",
RATING_NO_DATA:				"Рейтинг не доступні."
},
// اردو (Urdu)
"ur": {
...
STOP_PLAYER:				"ویڈیو بفرن بند کرو",
...
STOP_PLAYER:				"Dừng đoạn video đệm",
